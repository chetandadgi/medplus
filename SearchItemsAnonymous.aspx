<%@ Page Language="C#" MasterPageFile="~/login.master" AutoEventWireup="true" MaintainScrollPositionOnPostback="true" CodeFile="SearchItemsAnonymous.aspx.cs" Inherits="test" Title="Medplus" %>
                ...
                <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <asp:HyperLinkField DataNavigateUrlFields="ProductID" 
                            ...
                            DataNavigateUrlFormatString="DiscriptionPurchaseAnynomous.aspx?ProductID={0}" 
                        ...
                        <asp:ImageField DataImageUrlField="ProductImageThumb" 
                            ...
                            DataAlternateTextField="ProductID" 
                            DataAlternateTextFormatString="DiscriptionPurchase?ProductID={0}" 
